...
public class UpcomingSongAdapter extends RecyclerView.Adapter<UpcomingSongAdapter.ViewHolder> {

    private List<FileModel> songlist;
    private OnItemClickListener listener;
    private MainActivity mainActivity;
    public UpcomingSongAdapter(List<FileModel> songlist, MainActivity mainActivity) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FileModel musicFile = songlist.get(position);
