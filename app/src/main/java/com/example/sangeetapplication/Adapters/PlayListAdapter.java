...
public class PlayListAdapter extends RecyclerView.Adapter<PlayListAdapter.ViewHolder> {
    ...
    private List<FileModel> playlistSongs;
    private OnItemClickListener listener;
    private MainActivity mainActivity;

    public PlayListAdapter(List<FileModel> playlistSongs, MainActivity mainActivity) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FileModel musicFile = playlistSongs.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (position != RecyclerView.NO_POSITION && listener != null) {
                        listener.onItemClick(playlistSongs.get(position));
                    }
                }
            });
        }
